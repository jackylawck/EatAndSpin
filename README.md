...
* 🔒 **Privacy-First (No Backend):** 100% client-side computing. No location or user data is ever sent to or saved on a backend server.
* 🌐 **Bilingual Interface:** Toggle between English and Traditional Chinese (zh-HK) seamlessly.

---

## 🛠️ Tech Stack 技術架構

* **Frontend:** HTML5, CSS3, Pure JavaScript (ES Modules, Canvas API)
