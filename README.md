...
香港專屬、結合動態加權投票與地點檢索的餐飲與團隊決策 Web App！

「食一轉 · Eat & Spin」旨在解決上班族與團隊每天最煩惱的「食乜好」與聚會決策問題。不限於午餐，亦支援下午茶、晚餐宵夜及團隊活動；結合周邊餐廳自動檢索、自訂地點查詢、A/B/C/D 餐牌模式，以及獨創的團隊投票加權輪盤，讓各類選擇兼具效率與娛樂性！
